...
if (isset($_POST["kirim"])){
    ...
    $siswa = $_POST["siswa"];
    $mapel = $_POST["mapel"];
    $sql = "INSERT INTO Nilai (NIS,Mapel,Nilai,kelas,semester) VALUES ('$siswa','$mapel','$nilai','$kelas','$semester')";
							...
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="POST" >
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name = "siswa" tabindex="1" data-placeholder="Pilih Siswa" class="span8" required>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name = "semester" tabindex="1" data-placeholder="Pilih Semester" class="span8" required>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<select name = "mapel" tabindex="1" data-placeholder="Pilih Siswa" class="span8" required>
													<option value="">Pilih Mapel</option>
                                                    <?php for ($i=0; $i < count($matapelajaran) ; $i++) { 
                                                        
                                                    ?>
                                                    <option value="<?=$matapelajaran[$i]['id'] ?>"><?=$matapelajaran[0]['KodeMapel'] ?> - <?=$matapelajaran[$i]['MataPelajaran'] ?></option>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<input type="text" id="nilai" name = "nilai" placeholder="Type something here..." class="span8" required>
												<span class="help-inline">Minimum 5 Characters</span>
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
												<button type="submit" class="btn" name = "kirim">Submit Form</button>
											</div>
										</div>
									</form>
							</div>
