...
//  quey tabel murid
$wali = mysqli_query($koneksi, "SELECT * FROM murid where Kelas = '$kelas'");
...
<head>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html"><img src="sdlogo.png" style="width:90px;height:80px;">
                                     SD SUKAMAJU</a>
 ...
 <?php $i =1; ?>
      <?php while( $kelas1 = mysqli_fetch_assoc($wali) ) : ?>
 <tr>
 <td><?= $kelas1["NIS"]?></td>
  <td><?= $kelas1["Nama"]?></td>
  <td><?= $kelas1["Kelas"]?></td> 
  <td><?= $kelas1["Alamat"]?></td> 
  <td><?= $kelas1["No_HPWali"]?></td> 
 </tr>
